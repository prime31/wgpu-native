...
pub const SamplerBindingLayout = extern struct {
    next_in_chain: [*c]const ChainedStruct = @import("std").mem.zeroes([*c]const ChainedStruct),
    type: SamplerBindingType = @import("std").mem.zeroes(SamplerBindingType),
};

pub const SamplerDescriptor = extern struct {
    next_in_chain: [*c]const ChainedStruct = @import("std").mem.zeroes([*c]const ChainedStruct),
    label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    address_mode_u: AddressMode = @import("std").mem.zeroes(AddressMode),
    address_mode_v: AddressMode = @import("std").mem.zeroes(AddressMode),
    address_mode_w: AddressMode = @import("std").mem.zeroes(AddressMode),
    ...
    lod_max_clamp: f32 = @import("std").mem.zeroes(f32),
    compare: CompareFunction = @import("std").mem.zeroes(CompareFunction),
    max_anisotropy: u16 = @import("std").mem.zeroes(u16),
};
...
pub const TextureViewDescriptor = extern struct {
    ...
    mip_level_count: u32 = @import("std").mem.zeroes(u32),
    base_array_layer: u32 = @import("std").mem.zeroes(u32),
    array_layer_count: u32 = @import("std").mem.zeroes(u32),
...
pub const DepthStencilState = extern struct {
    ...
    stencil_read_mask: u32 = @import("std").mem.zeroes(u32),
    stencil_write_mask: u32 = @import("std").mem.zeroes(u32),
...
pub const TextureDescriptor = extern struct {
    ...
    label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    usage: TextureUsage = @import("std").mem.zeroes(TextureUsage),
    dimension: TextureDimension = @import("std").mem.zeroes(TextureDimension),
...
pub const ColorTargetState = extern struct {
    ...
    write_mask: ColorWriteMask = @import("std").mem.zeroes(ColorWriteMask),
};
...
pub const RenderPipelineDescriptor = extern struct {
    ...
    primitive: PrimitiveState = @import("std").mem.zeroes(PrimitiveState),
    depth_stencil: [*c]const DepthStencilState = @import("std").mem.zeroes([*c]const DepthStencilState),
    multisample: MultisampleState = @import("std").mem.zeroes(MultisampleState),
...
pub const Extent3D = extern struct {
    width: u32 = @import("std").mem.zeroes(u32),
    height: u32 = @import("std").mem.zeroes(u32),
    depth_or_array_layers: u32 = @import("std").mem.zeroes(u32),
};
